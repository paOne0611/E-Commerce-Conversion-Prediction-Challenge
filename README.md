...
1. submission.csv -> Predictions for all records in private_test.csv. 
2. Jupyter Notebook (.ipynb) -> Name it as notebook.ipynb .The notebook used to generate the final submission. The notebook must be reproducible and correspond to the submitted predictions. 
3. One-Page Report (.pdf) -> A one-page summary of the methodology used to generate the final submission.  Failure to submit any required file may result in disqualification.
